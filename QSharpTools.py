...
class SharpButton(QPushButton):
    def __init__(self, Window, primaryColor = "rgb(0, 179, 60)", secondaryColor = "rgb(204, 255, 221)", font_family = "Verdana", font_size = "13px", font_weight = "normal", border_style = "solid", pressed_border_color = "rgb(240, 240, 240)", border_width = "2px", border_radius = "0px"):
